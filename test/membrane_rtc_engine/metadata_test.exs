defmodule Membrane.RTC.MetadataEngineTest do
  use ExUnit.Case
  ...
  describe "updating track metadata" do
    test "triggers trackUpdated event", %{rtc_engine: rtc_engine} do
      ...
      endpoint = %MetadataEndpoint{rtc_engine: rtc_engine, track: track}
      ...
      assert %{
               "type" => "tracksAdded",
               "data" => %{"trackIdToMetadata" => %{track_id => nil}, "peerId" => peer_id}
             } == Jason.decode!(data)
