defmodule Membrane.RTC.EngineTest do
  ...
  describe "sending message to endpoint" do
    test "engine forward message to endpoint", %{rtc_engine: rtc_engine} do
    ...
    test "sending message to endpoint that doesn't exist do nothing", %{rtc_engine: rtc_engine} do
      endpoint_id = :test_endpoint
