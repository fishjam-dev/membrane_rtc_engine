  ...
  defp deps do
    [
      {        :membrane_telemetry_metrics,
        ...
        path: "/Users/feliks/membrane/membrane_telemetry_metrics"
      },
      ...
      {:membrane_rtp_h264_plugin, path: "/Users/feliks/membrane/membrane_rtp_h264_plugin", override: true},
      # {:membrane_rtp_vp8_plugin, "~> 0.3.0", override: true},
      {:membrane_rtp_vp8_plugin,
       path: "/Users/feliks/membrane/membrane_rtp_vp8_plugin",
       override: true},
      # {:membrane_rtp_format, "~> 0.4.0", override: true},
      {:membrane_rtp_format, path: "/Users/feliks/membrane/membrane_rtp_format", override: true},
      {:uuid, "~> 1.1"},
      {:jason, "~> 1.2"},
