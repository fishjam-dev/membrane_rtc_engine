...
#       |> Enum.flat_map(fn _ ->
#         [
#           # Commented due to errors during connection with firefox
#           # {:firefox, @firefox_capabilities},
#           {:chrome, @chrome_capabilities}
#         ]
#       end)
...
#   def sessions_for_browser(%{browser_sessions: sessions}, browser, n)
#       when n <= 6 and browser in [:chrome, :firefox] do
...
#     user_entries =
#       prepare_users(
#         sessions_for_browser(ctx, :chrome, 6) ++ sessions_for_browser(ctx, :firefox, 0)
#       )
...
#           assert_receive {:room, :new_peer}, 10_000
...
#     user_entries =
#       prepare_users(
#         sessions_for_browser(ctx, :chrome, 5) ++ sessions_for_browser(ctx, :firefox, 0)
#       )
...
#     user_entries =
#       prepare_users(
#         sessions_for_browser(ctx, :chrome, 4) ++ sessions_for_browser(ctx, :firefox, 0)
#       )
